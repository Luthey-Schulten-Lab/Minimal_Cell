...
def initLipConcs(pmap):
    ...
    lipMets = ["udpg_c","udpgal_c","fa_c","ap_c","pa_c","glyc_c","glyc3p_c","apoACP_c","coa_c","pap_c",
          "1ag3p_c","cdpdag_c","pg3p_c","pg_c","clpn_c","12dgr_c","galfur12dgr_c",
          "udpgalfur_c"] #"chsterol_c""ACP_c","ACP_R_c",
...
#     sim.addParticles('CellSA_Lip',int(round(262988))) # 11/10 rescale, 53% Lipid
    pmap['CellSA_Lip'] = int(round(262988))
...
#     sim.addParticles('CellSA_Prot',int(round(239512))) # 11/10 rescale, 47% protein 
    pmap['CellSA_Prot'] = int(round(239512))
