...
cntrMetRxn = ["PGI","PFK","FBA","TPI","GAPD","PGK","PGM","ENO","PYK",
              ...
              "TKT2","RPE","RPI","PRPPS","PPM","PPM2","DRPA","GAPDP"] #"PDH_E1","PDH_E2"
...
aaMetIDs = ["M_ala__L_c", "M_arg__L_c",
    ...
    "M_pro__L_c", "M_ser__L_c", "M_thr__L_c", "M_trp__L_c", "M_tyr__L_c", "M_val__L_c", "M_alatrna_c",
    "M_argtrna_c",
...
cofactMetRxn = ["NCTPPRT","NNATr","NADS","NADK","RBFK","FMNAT","5FTHFPGS","FTHFCL","MTHFC","GHMT","MTHFD"]
...
#             print(spcID,pmap[spcID],Rxns.partTomM(pmap[spcID],pmap))
...
#         print(mmcode, jcvi2ID, jcvi3AID)
        ...
        newMetID = "P_" + locusNum.lstrip('0') #jcvi3AID + "_c"
...
#     print('Adding PUNP5')
    ...
    enzConc_PUNP5 = Rxns.partTomM(pmap['P_747'],pmap) # mM
    ...
    ### ADD ATPase
    enzConc_ATPase = Rxns.partTomM(pmap['P_789'],pmap)
    #RateForm
    ...
    enzConc_PIabc = Rxns.partTomM(pmap['P_427'],pmap)
    ...
    enzConc_NUCabc = Rxns.partTomM(min(pmap['P_9'],pmap['P_10']),pmap)
#     print(enzConc_NUCabc)
    ...
    model.addParameter('ADNabc','kcatF', 2)
    ...
    model.addParameter('DADNabc','kcatF', 0.7)
    ...
    model.addParameter('DGSNabc','kcatF', 0.7)
    ...
    model.addParameter('URIabc','kcatF', 2)
    ...
    model.addParameter('DCYTabc','kcatF', 0.5)
    ...
    model.addParameter('THMDabc','kcatF',0.75)
    ...
    enzConc_SPRMabc = Rxns.partTomM(min(pmap['P_195'],pmap['P_196'],pmap['P_197']),pmap)
...
#     model.addParameter('THMDabc','KmProd3',2.8)
    ...
    enzConc_NACabc = Rxns.partTomM(pmap['P_314'],pmap)
...
#     model.addParameter('THMDabc','KmProd3',2.8)
    ...
    enzConc_RIBFLVabc = Rxns.partTomM(min(pmap['P_641'],pmap['P_642'],pmap['P_643'],pmap['P_877']),pmap)
...
#     model.addParameter('THMDabc','KmProd3',2.8)
    ...
    enzConc_FTHFabc = Rxns.partTomM(min(pmap['P_641'],pmap['P_642'],pmap['P_643'],pmap['P_822']),pmap)
...
#     model.addParameter('THMDabc','KmProd3',2.8)
    ...
    enzConc_THMPPabc = Rxns.partTomM(min(pmap['P_706'],pmap['P_707'],pmap['P_708']),pmap)
...
#     model.addParameter('THMDabc','KmProd3',2.8)
    ...
    enzConc_P5Pabc = Rxns.partTomM(min(pmap['P_641'],pmap['P_642'],pmap['P_643'],pmap['P_345']),pmap)
...
#     model.addParameter('THMDabc','KmProd3',2.8)
    ...
    enzConc_Kt6 = Rxns.partTomM(pmap['P_686'],pmap)
    ...
    enzConc_cat2 = Rxns.partTomM(pmap['P_879'],pmap)
    ...
    enzConc_mg2 = Rxns.partTomM(pmap['P_787'],pmap)
    ...
    enzConc_GluTrans = Rxns.partTomM(pmap['P_886'],pmap)
    enzConc_AaTransSymp = Rxns.partTomM(pmap['P_876'],pmap) + Rxns.partTomM(pmap['P_878'],pmap)
    enzConc_AaTransAbc = Rxns.partTomM(pmap['P_168'],pmap)
...
#             print(metID)
    ...
    model.addParameter(rxnIndx,'Enzyme',Rxns.partTomM(pmap['P_799'],pmap))
    ...
    model.addParameter(rxnIndx,'Enzyme',Rxns.partTomM(pmap['P_259'],pmap))
