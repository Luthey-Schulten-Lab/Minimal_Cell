        ...
        def hookSimulation(self, time):
                ...
                # We are at a CME-ODE communication timestep
                    ...
                    if (int(time)/60).is_integer():
                        ...
                        fluxFileName = './fluxes/scan125-zan/' + 'rep-' + self.procID + '-fluxDF.csv' #'/fluxDF_'+str(self.iter)+'min_start.csv'
                        ...
                        fluxFileName = './fluxes/scan125-zan/' + 'rep-' + self.procID + '-fluxDF-end.csv' #'/fluxDF_'+str(self.iter)+'min_end.csv'
