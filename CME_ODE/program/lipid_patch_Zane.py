...
def addTransportParams(model,pmap):
    ...
    Kcat_FBA_SM = 1.10e-3*(volToSA/2.0)*0.95#*volToSA#/VolToSA # mM/s, Uptake flux from lipidomics adjusted FBA
    ...
    Kcat_FBA_PC = 1.42e-4*(volToSA/2.0)*0.95#*volToSA#/VolToSA # mM/s, Uptake flux from lipidomics adjusted FBA
    ...
    Kcat_FBA_TAG = 0.0003095*(volToSA/2.0)*0.95#*volToSA # mM/s, Uptake Flux Triacylglycerol from FBA
