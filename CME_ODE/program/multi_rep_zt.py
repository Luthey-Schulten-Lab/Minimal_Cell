...
#from MCrestartLoop_twoRep import getConc
...
def addRepInit(sim):
    ...
    sim.defineSpecies(nonOricSpec)
    sim.addParticles(species = 'High_Affinity_Site2', count = 0)
    sim.addParticles(species = 'High_Affinity_Bound2', count = 0)
    sim.addReaction(('High_Affinity_Site2', 'M_DnaA_c'),'High_Affinity_Bound2',k_high)
    
    sim.addParticles(species = 'High_Affinity_Site_oriC2', count = 0)
    sim.addParticles(species = 'Low_Affinity_Site2_1', count = 0)
    sim.addParticles(species = 'Low_Affinity_Site2_2', count = 0)
    ...
    sim.addParticles(species = 'ssDNAunboundSite2_1', count = 0) #starts at 1(only site existing @ start
    ...
    sim.defineSpecies(nonOricSpec)
    sim.addParticles(species = 'High_Affinity_Site3', count = 0)
    sim.addParticles(species = 'High_Affinity_Bound3', count = 0)
    sim.addReaction(('High_Affinity_Site3', 'M_DnaA_c'),'High_Affinity_Bound3',k_high)
    
    sim.addParticles(species = 'High_Affinity_Site_oriC3', count = 0)
    sim.addParticles(species = 'Low_Affinity_Site3_1', count = 0)
    sim.addParticles(species = 'Low_Affinity_Site3_2', count = 0)
    ...
    sim.addParticles(species = 'ssDNAunboundSite3_1', count = 0) #starts at 1(only site existing @ start
...
def addReplication(sim,genome3A_DNA,ModelSpecies):    
    dna = genome3A_DNA[0]
    ...
    sim.addParticles(species = 'chromosome_C', count = 1)
    
    chromosome_CC = ['chromosome_CC']
    sim.defineSpecies(chromosome_CC)
    sim.addParticles(species = 'chromosome_CC', count = 1)
    ...
    #             CMono2 = baseMap[ rnasequence[1] ]
                ...
                if geneID not in ModelSpecies:
                    ...
                    sim.addParticles(species = geneID, count = 1)

                intergenic = [intergenic_region]
                sim.defineSpecies(intergenic)
                sim.addParticles(species = intergenic_region, count = 0)
