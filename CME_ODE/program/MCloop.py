...
def addReplication():    
    ...
    #             CMono2 = baseMap[ rnasequence[1] ]
                ...
                RepProd = [intergenic_region,geneID,'Initiator_C']
...
#     print(CC_genes)
    ...
    #             CMono2 = baseMap[ rnasequence[1] ]
            ...
            RepProd = [intergenic_region,geneID,'Initiator_CC']
    ...
    print('C_bp: ',C_bp,' , ','CC_bp',CC_bp)


# ## Create a function to add all ODE metabolites as CME species
# 
# *Check*: apoACP not included now, should be incorporated from translation

# In[ ]:


# Update to steady-state concentrations
metDict = {'M_fa_c':6.01,
          'M_ap_c':0.023,
          'M_glyc_c':0.9558,
          'M_glyc3p_c':0.0282,
          ...
          'M_pg3p_c':0.1,
          'M_pg_c':11.86,
          'M_clpn_c':6.0} # apoACP not included now, should be incorporated from translation
...
fn = 'sims/scan125-ribo/out-' + str(procid) + '.lm'
my_log_file = 'sims/scan125-ribo/log-' + str(procid) + '.log'
...
try:
    os.mkdir('fluxes/scan125-ribo/'+ 'rep-' + str(procid))#+'fluxes')
    os.mkdir('sims/scan125-ribo/'+'rep-'+str(procid))
