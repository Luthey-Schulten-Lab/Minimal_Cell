...
for sTime in np.arange(1,runTime,1):
    ...
    from updated_translated_rate_503_trna import TranslatRate as TranslatRate
    ...
    #else:
    from multi_rep_two import addRepInitTwo as addRepInitTwo
    from multi_rep_two import addReplicationTwo as addReplicationTwo
